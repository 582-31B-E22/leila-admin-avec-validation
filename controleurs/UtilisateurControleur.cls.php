...
class UtilisateurControleur extends Controleur
{
    ...
    public function ajouter()
    {
        ...
        if($erreurValidation) {
            // On injecte l'adresse courriel dans le gabarit pour pouvoir l'afficher dans le formulaire
    ...
    private function envoyerMessageConfirmationCompte($courriel, $cc) {
        $sujet = "Confirmation de votre compte Leila Admin";
        $message = "
        <html>
            <head>
                <title>Confirmation de votre compte Leila Admin</title>
            </head>
            <body>
        ...
        $entetes[] = 'From: Leila Admin <admin@leila.com>';
